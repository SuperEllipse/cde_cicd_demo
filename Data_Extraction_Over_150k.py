...
# input_path ='s3a://go01-demo/user/vishr/data/cde/PPP-Over-150k-ALL.csv'
...
spark = SparkSession\
    .builder\
    .appName("DataExploration")\
    .config("spark.yarn.access.hadoopFileSystems","abfs://data@go01demoazure.dfs.core.windows.net/")\
    .getOrCreate()

#The path of our file in S3
input_path ='abfs://data@go01demoazure.dfs.core.windows.net/user/vishrajagopalan/data/PPP-Over-150k-ALL.csv'



#Bring data into our Spark job from  bucket
...
print("How many TX records did we get?")
tx_cnt = texas_df.count()
print("We got: %i " % tx_cnt)
